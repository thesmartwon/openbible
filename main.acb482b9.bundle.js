...
function Settings(_props) {
  var _useState = Object(hooks_module["c" /* useState */])({}),
      cssValues = _useState[0],
      setCSSValues = _useState[1];

  var _useLocalStorage = useLocalStorage('settings', defaultSettings),
      config = _useLocalStorage[0],
      setConfig = _useLocalStorage[1];

  Object(hooks_module["a" /* useEffect */])(function () {
    var docStyles = getComputedStyle(document.body);
    var docCSSVars = cssVars.reduce(function (acc, cur) {
  ...
  var onSetCSSVar = function onSetCSSVar(cssVar, cssValue) {
    document.body.style.setProperty(cssVar, cssValue);
    cssValues[cssVar] = cssValue;
    setCSSValues(Object.assign({}, cssValues));
  };
  ...
  var onReset = function onReset(ev) {
    ...
    setConfig(Object.assign({}, defaultSettings));
  };
  ...
  return Object(preact_module["h"])(preact_module["Fragment"], null, Object(preact_module["h"])(Nav, null), Object(preact_module["h"])("main", null, Object(preact_module["h"])("form", {
    ...
    onSubmit: onSubmit,
    onReset: onReset
  }, Object(preact_module["h"])("h2", null, "CSS Variables"), Object.entries(cssValues).map(function (entry) {
    return Object(preact_module["h"])("p", {
      key: entry[0]
      ...
      onInput: function onInput(ev) {
        return onSetCSSVar(entry[0], ev.target.value);
      }
    }));
...
function App() {
  Object(hooks_module["a" /* useEffect */])(loadLocalCSSVars, []);
...
//# sourceMappingURL=main.acb482b9.bundle.js.map